...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 AceVra 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 AceVra 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 AceVra 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 AceVra",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 AceVra。",
  ...
  "startup.global.starting_services": "正在启动 AceVra",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 AceVra。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 AceVra 后生效。",
  ...
  "conversationShare.permission.linkEditorHint": "可导入到 AceVra",
  ...
  "conversationShare.import.loginRequired": "该分享暂不支持匿名导入，请登录 AceVra 后重试",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 AceVra？",
  ...
  "modelTrajectory.empty": "暂无模型调用记录（仅 AceVra Agent 会落盘 model-io）",
  ...
  "titleBar.menu.help.about": "关于 AceVra",
  ...
  "titleBar.menu.help.toggleAceVraStdioTap": "抓取 Agent stdio 通信",
  ...
  "forceUpdate.title": "需要升级 AceVra 后继续使用",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 AceVra 即可继续使用。",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 AceVra 终端的字体覆盖。",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "在 AceVra 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 AceVra 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "settings.accounts.navGroup": "已连接账号",
  "settings.accounts.source.codex": "Codex",
  "settings.accounts.source.claudeCode": "Claude Code",
  "settings.accounts.description.codex":
    "Codex 是经过认证的外部执行账号，不是模型供应商。通过 Codex App Server 登录并导入其本地会话记录，凭据始终留在 Codex 一侧。",
  "settings.accounts.description.claudeCode":
    "Claude Code 是经过认证的外部执行账号，不是模型供应商。通过 Claude Code CLI 登录并导入其本地会话记录，凭据始终留在 Claude 一侧。",
  "settings.accounts.bridge.connected": "已连接",
  "settings.accounts.bridge.connecting": "正在连接…",
  "settings.accounts.bridge.disconnected": "未连接",
  "settings.accounts.bridge.notInstalled": "未安装",
  "settings.accounts.bridge.error": "连接异常",
  "settings.accounts.auth.signedIn": "已登录",
  "settings.accounts.auth.signedOut": "未登录",
  "settings.accounts.action.connect": "连接",
  "settings.accounts.action.reconnect": "重新连接",
  "settings.accounts.action.restartBridge": "重启桥接",
  "settings.accounts.action.disconnect": "从本机断开",
  "settings.accounts.action.scan": "扫描",
  "settings.accounts.action.refresh": "刷新",
  "settings.accounts.disconnectHint": "断开只停止本机桥接，不会退出你的 {source} 登录状态。",
  "settings.accounts.installHint.codex":
    "未在本机找到随应用分发的 Codex 客户端。安装 ChatGPT 桌面端后即可连接 Codex。",
  "settings.accounts.installHint.claudeCode":
    "未在 PATH 中找到 Claude Code CLI。安装 Claude Code 后即可连接该账号。",
  "settings.accounts.error.status_refresh_failed": "无法从本地客户端读取账号状态。",
  "settings.accounts.error.connect_failed": "连接失败。",
  "settings.accounts.error.codex_history_scan_failed": "无法读取 Codex 的本地会话记录。",
  "settings.accounts.import.codexTitle": "导入 Codex 历史",
  ...
  "settings.accounts.usage.blocked.workspaceCreditsDepleted": "工作区的包含额度已耗尽。",
  "settings.accounts.usage.blocked.workspaceUsageLimitReached": "工作区的包含额度已达上限。",
  "settings.accounts.usage.blocked.generic": "包含额度当前不可用。",
  "settings.migration.sectionTitle": "Claude 历史迁移",
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 AceVra 任务列表。",
  ...
  "resourceManager.storage.summaryTotal": "AceVra 总占用",
  ...
  "resourceManager.storage.diskUsage": "AceVra 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 AceVra 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "AceVra 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 AceVra。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。AceVra 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.mcp.description": "管理 AceVra Agent 使用的 MCP 服务器配置。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 AceVra 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 AceVra Agent 不支持 OAuth 状态刷新。请升级或重启 AceVra，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 AceVra。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 AceVra",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "支持 BYOK、BYOA；Base URL、API Format 和 API Key 由 AceVra 自动维护，无需手动配置。",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "请先在 BigModel 团队套餐管理页添加自己或其他成员，完成后即可在 AceVra 使用团队额度。",
  ...
  "settings.modelProvider.codingPlan.planDetailsUnavailable": "套餐详情暂不可用",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。AceVra 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。AceVra 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.modelProvider.commandCodeCli.title": "Command Code CLI 账号",
  "settings.modelProvider.commandCodeCli.authenticated": "已认证",
  "settings.modelProvider.commandCodeCli.notInstalled": "未安装",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 AceVra 即可继续编码。",
  ...
  "settings.usage.entitlementServerMcpUsage": "AceVra MCP",
  ...
  "sidebar.usage.plan.mcp": "AceVra MCP",
  "sidebar.usage.plan.zcodeMcp": "AceVra MCP",
  "sidebar.usage.plan.zcodeMcpDescription": "AceVra 预置插件 MCP 每日合计额度",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 AceVra。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。AceVra 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 AceVra",
  ...
  "settings.subagents.description": "管理 AceVra Agent 运行时消费的用户级子智能体 Markdown 文件。",
  ...
  "settings.plugins.store.subtitle": "用插件为 AceVra 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 AceVra，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。AceVra 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 AceVra",
  ...
  "settings.commands.description":
    "管理 AceVra Agent 的 .md 命令文件。命令可通过 /command-name 在聊天中调用。",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 AceVra。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。AceVra 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 AceVra",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 AceVra 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 AceVra",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 AceVra",
  "onboarding.welcome.start": "开始使用 AceVra",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 AceVra 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，AceVra 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 AceVra 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 AceVra 提问…",
  ...
  "chat.toolbar.backend.zcode.description": "使用内置 AceVra agent 执行任务",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 AceVra 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 AceVra 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 AceVra 修订后另存一版。",
  ...
  "chat.quota.mcp.quotaExhausted": "AceVra MCP「{server}」今日额度已用完，明天自动恢复。",
  ...
  "feedback.submit.template.section.copyErrorHeading": "AceVra 报错信息",
  ...
  "offPeak.keepAwakeBanner": "AceVra 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 AceVra 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "AceVra 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "AceVra 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 AceVra",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 AceVra 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，AceVra 会针对该会话精确验证电脑控制工具。",
