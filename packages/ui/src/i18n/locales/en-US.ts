...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like AceVra to show its work?",
  ...
  "occupationOnboarding.memoryDescription": "Let AceVra remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting AceVra",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen AceVra.",
  ...
  "startup.global.starting_services": "Starting AceVra",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "AceVra will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another AceVra or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen AceVra. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen AceVra to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen AceVra.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a AceVra restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into AceVra",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to AceVra and try again",
  ...
  "logout.confirm.title": "Disconnect and restart AceVra?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only AceVra Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About AceVra",
  ...
  "titleBar.menu.help.toggleAceVraStdioTap": "Capture agent stdio traffic",
  ...
  "forceUpdate.title": "Update AceVra to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart AceVra to continue.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "AceVra checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the AceVra terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While AceVra is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the AceVra installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching AceVra task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by AceVra",
  ...
  "resourceManager.storage.diskUsage": "AceVra uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the AceVra desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "AceVra could not verify its Windows secure import component. Reinstall or update AceVra before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, AceVra will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by AceVra Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "AceVra provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This AceVra Agent cannot refresh OAuth status. Upgrade or restart AceVra, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to AceVra to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into AceVra",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by AceVra automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in AceVra.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. AceVra uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in AceVra after purchase or setup.",
  ...
  "sidebar.usage.plan.zcodeMcpDescription": "Daily aggregate quota for AceVra built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into AceVra. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. AceVra follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into AceVra",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by AceVra Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend AceVra with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into AceVra and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. AceVra follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into AceVra",
  ...
  "settings.commands.description":
    "Manage AceVra Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.zcodeAgent": "AceVra Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into AceVra. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. AceVra follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into AceVra",
  ...
  "settingsSync.action.finish": "Start using AceVra",
  "settingsSync.agent.zcode": "AceVra Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current AceVra settings will not be overwritten.",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while AceVra imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "AceVra will copy {source} to {target}.\nIf the target file already exists, the AceVra default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask AceVra anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask AceVra anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, AceVra will continue switching models.",
  ...
  "chat.toolbar.backend.zcode.label": "AceVra",
  "chat.toolbar.backend.zcode.description": "Run tasks with the built-in AceVra agent",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want AceVra to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart AceVra app and retry, or ask AceVra to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with AceVra in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for AceVra: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with AceVra in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current AceVra Agent session",
  ...
  "resourceManager.appUsage": "AceVra",
  ...
  "feedback.submit.template.section.copyErrorHeading": "AceVra Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while AceVra is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task AceVra can work on in the background, including the expected result and any constraints…",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart AceVra",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart AceVra to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified AceVra plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "AceVra will verify the Computer Use tools against the exact session when your first session starts.",
