...
const ABOUT_APPLICATION_NAME = "AceVra";
...
> = {
  "zh-CN": {
    aboutTitle: "关于 AceVra",
    versionLabel: "版本",
    okButtonLabel: "确定",
    optimizedForAppleSilicon: "已针对 Apple Silicon 优化。",
    copyright: (year) => `版权所有 © ${year} AceVra。基于 ZCode。`,
  },
  "en-US": {
    aboutTitle: "About AceVra",
    versionLabel: "version",
    okButtonLabel: "OK",
    optimizedForAppleSilicon: "Optimized for Apple Silicon.",
    copyright: (year) => `Copyright © ${year} AceVra. Based on ZCode.`,
  },
};
