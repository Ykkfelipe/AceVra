...
- App identity, bundle identifiers, protocol handlers, data directories, and production behavior
...
4. The fork registers `zcode-fork:` and official ZCode retains `zcode:`.
